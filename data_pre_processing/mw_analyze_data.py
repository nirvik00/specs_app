...
def ask_question_2():
    ...
    ans = "Yes"
    Q2 = get_question_sections_as_dict(SEC_NUMS_EVERY_PROJECT, SEC_NUMS_COLS, 2, q3_desc, ans)
    all_question_sections.append(Q2)
    return all_question_sections
...
def ask_question_3():
    ...
    Q3_1 = get_question_sections_as_dict(SEC_NUMS_EVERY_PROJECT, SEC_NUMS_COLS, 3, q3_desc_1, ans)
    all_question_sections.append(Q3_1)

    # col M
    q3_desc_2 = """Is the project multiple stories?\nYes (Renovation)"""
    ans = "Yes, Renovation"
    Q3_2 = get_question_sections_as_dict(SEC_NUMS_EVERY_PROJECT, SEC_NUMS_COLS, 3, q3_desc_2, ans)
...
def ask_question_4():
    ...
    ans = "Metal Panel"
    Q4_3 = get_question_sections_as_dict(SEC_NUMS_EVERY_PROJECT, SEC_NUMS_COLS, 4, q4_desc_3, ans)
    ...
    Q4_4 = get_question_sections_as_dict(SEC_NUMS_EVERY_PROJECT, SEC_NUMS_COLS, 4, q4_desc_4, ans)
    all_question_sections.append(Q4_4)

    # col Q
    q4_desc_5 = """What are the opaque exterior materials? (Select as many as applicable)\nTerra Cotta"""
    ans = "Terra Cotta"
    Q4_5 = get_question_sections_as_dict(SEC_NUMS_EVERY_PROJECT, SEC_NUMS_COLS, 4, q4_desc_5, ans)
    all_question_sections.append(Q4_5)

    # col R
    q4_desc_6 = """What are the opaque exterior materials? (Select as many as applicable)\nPhenolic Panel"""
    ans = "Phenolic Panel"
    Q4_6 = get_question_sections_as_dict(SEC_NUMS_EVERY_PROJECT, SEC_NUMS_COLS, 4, q4_desc_6, ans)
    all_question_sections.append(Q4_6)

    # col S
    q4_desc_7 = """What are the opaque exterior materials? (Select as many as applicable)\nEIFS"""
    ans = "EIFS"
    Q4_7 = get_question_sections_as_dict(SEC_NUMS_EVERY_PROJECT, SEC_NUMS_COLS, 4, q4_desc_7, ans)
    ...
    Q4_8 = get_question_sections_as_dict(SEC_NUMS_EVERY_PROJECT, SEC_NUMS_COLS, 4, q4_desc_8, ans)
    all_question_sections.append(Q4_8)

    # col U
    q4_desc_9 = """What are the opaque exterior materials? (Select as many as applicable)\nCast Stone"""
    ans = "Cast Stone"
    Q4_9 = get_question_sections_as_dict(SEC_NUMS_EVERY_PROJECT, SEC_NUMS_COLS, 4, q4_desc_9, ans)
    ...
    Q4_10 = get_question_sections_as_dict(SEC_NUMS_EVERY_PROJECT, SEC_NUMS_COLS, 4, q4_desc_10, ans)
...
def ask_question_6():
    ...
    ans = "Tile"
    Q6_3 = get_question_sections_as_dict(SEC_NUMS_EVERY_PROJECT, SEC_NUMS_COLS, 6, q6_desc_3, ans)
    all_question_sections.append(Q6_3)

    # col AA
    q6_desc_4 = """What are the anticipated floor finishes? (Select as many as applicable)\nWood"""
    ans = "Wood"
    Q6_4 = get_question_sections_as_dict(SEC_NUMS_EVERY_PROJECT, SEC_NUMS_COLS, 6, q6_desc_4, ans)
    all_question_sections.append(Q6_4)

    # col AB
    q6_desc_5 = """What are the anticipated floor finishes? (Select as many as applicable)\nTerrazzo"""
    ans = "Terrazzo"
    Q6_5 = get_question_sections_as_dict(SEC_NUMS_EVERY_PROJECT, SEC_NUMS_COLS, 6, q6_desc_5, ans)
...
def ask_question_7():
    ...
    Q7_1 = get_question_sections_as_dict(SEC_NUMS_EVERY_PROJECT, SEC_NUMS_COLS, 7, q7_desc_1, ans81)
    ...
    Q7_2 = get_question_sections_as_dict(SEC_NUMS_EVERY_PROJECT, SEC_NUMS_COLS, 7, q7_desc_2, ans82)
    all_question_sections.append(Q7_2)

    # col AE
    q7_desc_3 = """Are there any special ceiling materials? (Select as many as applicable)\nWood"""
    ans83 = "Wood"
    Q7_3 = get_question_sections_as_dict(SEC_NUMS_EVERY_PROJECT, SEC_NUMS_COLS, 7, q7_desc_3, ans83)
    all_question_sections.append(Q7_3)

    # col AF
    q7_desc_4 = """Are there any special ceiling materials? (Select as many as applicable)\nMetal"""
    ans84 = "Metal"
    Q7_4 = get_question_sections_as_dict(SEC_NUMS_EVERY_PROJECT, SEC_NUMS_COLS, 7, q7_desc_4, ans84)
